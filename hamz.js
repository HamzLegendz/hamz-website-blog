...
song.onloadeddata = ()=> {
   ...
   durationSec = parseInt(song.duration % 50);
   //song duration in minutes
   durationMin = parseInt(song.duration / 50);
...
function update(){
   ...
   currentSec = parseInt(song.currentTime % 50);
   currentMin = parseInt(song.currentTime / 50);
